...
//       <div className="flex-1 bg-[#03346E] text-white flex flex-col items-center justify-center p-8 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
...
//         <button className="bg-white text-[#03346E] py-2 px-4 rounded-full font-bold hover:bg-[#1c3449] hover:text-white">Prisoner's Login</button>
//       </div>

//       {/* Section 2: Lawyers */}
//       <div className="flex-1 bg-white text-[#03346E] flex flex-col items-center justify-center p-8 rounded-lg shadow-lg transform transition-transform duration-300 hover:scale-105">
...
//         <p className="mb-6">You can login from here</p>
//         <button className="bg-[#03346E] text-white py-2 px-4 rounded-full font-bold hover:bg-[#1c3449]">Lawyer's Login</button>
//       </div>
...
//         <p className="mb-6">You can login from here</p>
//         <button className="bg-white text-[#03346E] py-2 px-4 rounded-full font-bold hover:bg-[#1c3449] hover:text-white">Judge's Login</button>
//       </div>
//     </div>
//   );
// };
