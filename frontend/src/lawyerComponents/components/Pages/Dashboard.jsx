...
const Dashboard = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-white">
        ...
        <div>
          ...
          <ul>
            {[
              ...
              <li
                key={item}
                className={`cursor-pointer mb-4 px-4 py-2 rounded-lg transition-colors duration-300 hover:bg-white hover:text-primary ${
      ...
      {/* Main Content */}
      <div className="flex-1 p-8 lg:ml-64">{renderComponent()}</div>
    </div>
  );
};
