...
const Precedents = () => {
  ...
  const precedentsData = [
    {
      caseNumber: "001",
      description: "Case where defendant was acquitted based on self-defense.",
      date: "2023-01-15",
      status: "Closed",
    },
    {
      caseNumber: "002",
      description: "Case involving breach of contract with a focus on damages.",
      date: "2023-02-20",
      status: "Reviewed",
    },
    {
      caseNumber: "003",
      description:
        "Case where previous judgments were used to determine liability.",
      date: "2023-03-10",
      status: "Pending",
    },
    {
      caseNumber: "004",
      description: "Landmark case on intellectual property rights.",
      date: "2023-04-05",
      status: "Approved",
    },
    {
      caseNumber: "005",
      description:
        "Case dealing with corporate fraud and its legal implications.",
      date: "2023-05-22",
      status: "Closed",
    },
  ];
    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Explore and manage the precedents used in various legal cases.
        </p>
      </div>
          ...
          >
            <div className="flex items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-800 mr-2">
                Case Number: {precedent.caseNumber}
              </h2>
