    ...
    <div>
      <nav className="p-4 bg-white mb-1">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div>
            <a
              href="#"
              className="text-white text-2xl font-bold flex align-middle items-center gap-2 "
            >
          ...
          <div className=" flex gap-4">
            ...
            <div className="lg:flex lg:items-center lg:space-x-4">
              <button
                ...
                className="text-white bg-[#03346E] hover:bg-[#0033A0] px-4 py-2 rounded"
              >
                Login
              </button>
              <button className="text-white bg-[#03346E] hover:bg-[#0033A0] px-4 py-2 rounded">
                Register
              </button>
            </div>
          </div>
      ...
      <div className=" bg-[#03346E] h-8 flex justify-center py-6">
        <div className="lg:flex lg:items-center lg:space-x-8 ">
          <a
            href="#home"
            className="text-white hover:font-bold hover:bg-red-900 p-1 rounded-lg"
          >
            Home
          </a>
          <a
