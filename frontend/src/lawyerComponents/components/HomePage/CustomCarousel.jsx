...
const CustomCarousel = () => {
  ...
  const slides = [
    {
      image:
        "https://img.freepik.com/free-photo/closeup-gavel-judgement-concept_53876-31913.jpg?uid=R91335437&ga=GA1.1.651042858.1721845919&semt=ais_hybrid",
      title: "Streamlined Bail Process",
      description:
        "Our platform simplifies the bail process, making it faster and more efficient for all parties involved.",
    },

    {
      image:
        "https://lawtrend.in/wp-content/uploads/2024/06/bhartiya-nyay-sanhita.jpg",
      title: "Procedural Compliance",
      description:
        "Ensure compliance with all procedural requirements through interactive checklists and real-time guidance.",
    },
    {
      image: img1,
      title: "Comprehensive Legal Aid",
      description:
        "Access comprehensive legal provisions and procedural checklists designed to support legal aid providers.",
    },
    {
      image: img2,
      title: "Eligibility Checker",
      description:
        "Quickly assess bail eligibility based on various factors with our easy-to-use eligibility checker tool.",
    },
    {
      image:
        "https://vajiram-prod.s3.ap-south-1.amazonaws.com/Bhartiya_Nyaya_Samhita_Bill_02b97ca307.jpg",
      title: "Automated Documentation",
      description:
        "Effortlessly generate and customize bail application documents with our automated documentation system.",
    },

    {
      image:
        "https://www.livelaw.in/h-upload/2022/06/13/1500x900_421712-sexual-offences-against-women.jpg",
      title: "Procedural Compliance",
      description:
        "Ensure compliance with all procedural requirements through interactive checklists and real-time guidance.",
    },
