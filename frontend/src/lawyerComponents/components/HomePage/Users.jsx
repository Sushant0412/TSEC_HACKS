    ...
    <div>
      ...
      <div id={id} className="flex space-x-4 p- bg-slate-100 px-16">
        <Card
          ...
          onClick={() =>
            handleClick("utp", "http://localhost:3000/prisoner/login")
          }
        />
        <Card
          ...
          name="Lawyers"
          onClick={() =>
            handleClick("Lawyer", "http://localhost:3000/lawyer/login")
          }
        />
        <Card
          ...
          name="Judges"
          onClick={() =>
            handleClick("Judge", "http://localhost:3000/judge/login")
          }
        />
      </div>
