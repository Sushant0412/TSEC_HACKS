...
const LegalQuery = () => {
  ...
  async function generateAnswer(e) {
    ...
    const isLegalQuery =
      /(law|legal|police|judge|lawyer|undertrial prisoner|court|trial|bail|attorney|jurisdiction|crime|offense|verdict|case)/i.test(
        question
      );
    if (!isLegalQuery) {
      setAnswer(
        "Please ask a question related to the legal system (e.g., law, police, judge, lawyer, undertrial prisoner)."
      );
          ...
          contents: [
            {
              parts: [
                {
                  text: `Please provide a short and precise answer related to the legal system: ${question}`,
                },
              ],
            },
          ],
