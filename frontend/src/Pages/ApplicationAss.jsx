...
const ApplicationAssistance = () => {
  return (
    <div className="bg-white p-10 rounded-lg shadow-xl max-w-5xl mx-auto overflow-hidden">
      <h2 className="text-3xl font-semibold text-[#00008B] mb-6">
      ...
      <div className="flex items-center justify-between overflow-hidden">
        ...
        <div className="flex flex-col items-center text-center w-1/4 group">
          ...
          <h3 className="text-xl font-semibold text-[#03346E] group-hover:text-[#00008B] transition-colors duration-300">
            Step 1
          </h3>
        ...
        <div className="flex flex-col items-center text-center w-1/4 group">
          ...
          <p className="text-gray-700 group-hover:text-gray-900 transition-colors duration-300">
            Complete the bail application form
          </p>
        </div>
      ...
      <div className="mt-10">
        <h3 className="text-2xl font-semibold text-[#03346E] mb-3">
